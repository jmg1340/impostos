<template>
  <div class="q-ma-md">
				...
				<q-table
						title="Despeses IVA deduible de tot l'any"
						:data="getDespesesIva"
						:columns="columnes"
						row-key="dataFra"
						separator="cell"
...
export default {
	...
	computed: {
		getDespesesIva () {
			console.log("imImpostos/getArrDespesesIVA", this.$store.getters["mImpostos/getArrDespesesIVA"] )
			return this.$store.getters["mImpostos/getArrObjDespesesIVA"] ;
		}
	}
}
</script>
